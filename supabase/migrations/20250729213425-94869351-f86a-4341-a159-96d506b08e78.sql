...
BEGIN
  ...
  -- Log how many notifications were cleaned up
  GET DIAGNOSTICS ROWCOUNT;
  RAISE LOG 'Cleaned up % expired ride notifications', ROWCOUNT;
  ...
  -- Log how many rides were cleaned up  
  GET DIAGNOSTICS ROWCOUNT;
  RAISE LOG 'Cleaned up % expired rides', ROWCOUNT;
END;
$$;
